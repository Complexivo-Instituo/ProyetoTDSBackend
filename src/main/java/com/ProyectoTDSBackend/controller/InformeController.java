...
import com.ProyectoTDSBackend.service.InformeService;
...
public class InformeController {
     ...
     */
	@GetMapping(value="anexo15", produces= MediaType.APPLICATION_PDF_VALUE)
	public @ResponseBody ResponseEntity<Object> getReportJasper(@RequestParam(name = "persona") Integer personaId){
		byte[] media = informeService.getJasperReport(1);
